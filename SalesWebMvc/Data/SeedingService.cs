...
namespace SalesWebMvc.Data
{
    public class SeedingService 
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(1, "Marcos Rocha", "marcos@gmail.com", new DateTime(1997, 2, 28), 1785.0, d4);
            Seller s3 = new Seller(1, "João Barros", "joao@gmail.com", new DateTime(1992, 10, 30), 3522.0, d2);
            Seller s4 = new Seller(1, "Roger Santos", "roger@gmail.com", new DateTime(1987, 1, 15), 4578.0, d3);
            Seller s5 = new Seller(1, "Harley Aquino", "harley@gmail.com", new DateTime(1985, 6, 23), 16000.0, d1);
            Seller s6 = new Seller(1, "Balmond Da Massa", "Balmond@gmail.com", new DateTime(1978, 11, 8), 48000.0, d2);
